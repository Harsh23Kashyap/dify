...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RecipientType.STANDALONE_WEB_APP, HumanInputSurface.WEB, True),
        (RecipientType.CONSOLE, HumanInputSurface.WEB, False),
        (RecipientType.BACKSTAGE, HumanInputSurface.WEB, False),
        (RecipientType.EMAIL_MEMBER, HumanInputSurface.WEB, False),
